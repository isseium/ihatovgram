...
require_once 'Ihatovgram_Error.php';
require_once 'Ihatovgram_ActionClass.php';
require_once 'Ihatovgram_ActionForm.php';
require_once 'Ihatovgram_ViewClass.php';
require_once 'Ihatovgram_UrlHandler.php';

/**
 *  Ihatovgram application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Ihatovgram
 */
class Ihatovgram_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Ihatovgram_View_Index',
         *  ),
         */
    );
    ...
    public $class = array(
        ...
        'form'          => 'Ihatovgram_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Ihatovgram_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Ihatovgram_UrlHandler',
    );
